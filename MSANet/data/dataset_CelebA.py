...
class CelebA(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if self.labels[index] == 'origin':
            ...
            mask = Image.open(
                os.path.join(self.data_path, self.labels[index], self.images[index][:-4] + '.png')).convert('1')
...
if __name__ == '__main__':
    ...
    dataloader = DataLoader(CelebA(data_path='../CelebA-Attr/CelebA-HQ-AttGAN/',
                                   data_list_path='../CelebA-Attr/CelebA-HQ-AttGAN/image_list.txt',
                                   attr_path='../CelebA-Attr/CelebA-HQ-AttGAN/list_attr_celeba.txt', mode='train',
